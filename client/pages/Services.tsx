...
export default function Services() {
  const serviceCategories = [
      ...
      services: [
        {
          ...
          description: 'Apply for or renew your Nepal citizenship certificate online',
          icon: <UserCheck className="h-8 w-8" />,
          features: ['Online Application', 'Document Upload', 'Status Tracking', 'Home Delivery'],
        ...
        },
        {
          ...
          features: ['Company Registration', 'Tax Registration', 'License Application', 'Certificate Download'],
    ...
    },
    {
      ...
      description: 'Pay utility bills, taxes, and government fees securely in NPR',
      color: 'bg-green-500',
      services: [
        {
          ...
          features: ['Monthly Bills', 'Due Date Reminders', 'Payment History', 'Receipt Download'],
        ...
        },
        {
          ...
          features: ['Municipality Bills', 'Consumption History', 'Auto Payment', 'SMS Alerts'],
          processingTime: 'Instant',
        ...
        },
        {
          ...
          features: ['Multiple Providers', 'Plan Details', 'Usage Tracking', 'Bundle Payments'],
          processingTime: 'Instant',
        ...
        },
        {
          ...
          features: ['Income Tax', 'Vehicle Tax', 'Property Tax', 'VAT Payments'],
          processingTime: 'Instant',
          fee: 'No service charge',
          href: '/payments'
        }
    ...
    },
    {
      ...
      description: 'Submit and track health insurance claims through SSF system',
      color: 'bg-red-500',
      services: [
        {
          title: 'SSF Health Claims',
          description: 'Submit claims to Social Security Fund for medical expenses',
          icon: <Stethoscope className="h-8 w-8" />,
          features: ['Claim Submission', 'Document Upload', 'Approval Tracking', 'Direct Reimbursement'],
        ...
        },
        {
          ...
          features: ['Expense Tracking', 'Receipt Management', 'Claim History', 'Payment Status'],
        ...
        },
        {
          ...
          features: ['Medical History', 'Prescription Records', 'Lab Reports', 'Doctor Consultations'],
      ...
      services: [
        {
          ...
          description: 'Track all your government application statuses in real-time',
          icon: <TrendingUp className="h-8 w-8" />,
          features: ['Real-time Updates', 'Progress Tracking', 'Document Status', 'Notification Alerts'],
          processingTime: 'Real-time',
          fee: 'Free service',
          href: '/dashboard'
        },
        {
          ...
          description: 'View complete history of all bill payments and transactions',
          icon: <BarChart3 className="h-8 w-8" />,
          features: ['Transaction History', 'Payment Analytics', 'Monthly Reports', 'Export Data'],
          processingTime: 'Real-time',
          fee: 'Free service',
          href: '/dashboard'
        },
        {
          ...
          features: ['SMS Alerts', 'Email Notifications', 'Due Date Reminders', 'Status Updates'],
          processingTime: 'Instant',
          fee: 'Free service',
          href: '/dashboard'
        }
  ...
  const stats = [
    ...
    { number: '200+', label: 'Services Available', icon: <FileText className="h-5 w-5" /> },
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg md:text-xl text-muted-foreground mb-8 max-w-3xl mx-auto">
              Access all government services, pay bills in NPR, manage health insurance, 
              and track everything through one comprehensive digital platform.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Comprehensive digital solutions for all your government, payment, and healthcare needs
            </p>
          </div>
              ...
              <TabsContent key={category.id} value={category.id}>
                <div className="space-y-6">
                  ...
                  <div className="text-center mb-8">
                    <div className={`inline-flex items-center justify-center p-3 ${category.color} rounded-full mb-4`}>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-muted-foreground mb-8">
              All services are backed by Nepal government security standards and 24/7 technical support.
            </p>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg text-muted-foreground mb-8">
              Create your account today and access all Nepal government services digitally.
            </p>
